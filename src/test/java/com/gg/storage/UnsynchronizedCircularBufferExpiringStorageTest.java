...
public class UnsynchronizedCircularBufferExpiringStorageTest {
    ...
    private ExpiringStorage<Integer> storage = new UnsynchronizedCircularBufferExpiringStorage<>(EXPIRATION_TIMEOUT, MAXIMUM_SIZE);
